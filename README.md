...
*   **`frontend/`** - The frontend web application (user interface).
*   **`model/`** - The directory containing the machine learning model, inference scripts, and presentation materials.
